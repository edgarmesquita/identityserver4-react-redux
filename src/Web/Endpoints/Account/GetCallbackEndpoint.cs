...
public class GetCallbackEndpoint : EndpointBaseAsync.WithoutRequest.WithActionResult
{
    private readonly UserManager<UserData> _userManager;
    private readonly SignInManager<UserData> _signInManager;
    private readonly IIdentityServerInteractionService _interaction;
    private readonly IEventService _events;
    private readonly ILogger<GetCallbackEndpoint> _logger;

    public GetCallbackEndpoint(
        UserManager<UserData> userManager,
        SignInManager<UserData> signInManager,
        IIdentityServerInteractionService interaction,
        IEventService events,
        ILogger<GetCallbackEndpoint> logger)
    {
    ...
    private async Task<UserData> AutoProvisionUserAsync(string provider, string providerUserId,
